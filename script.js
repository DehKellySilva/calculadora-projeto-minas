...
// Requisito 4
function sortMethod() {
  let sortCrescente = req4crescente.sort(function(a,b){
    return a - b;
  });
    //Seu código aqui, manipule a variável sem alterar o nome dela.
  let sortDecrescente = req4decrscente.sort(function(a,b){
    return b - a;
  }) //Seu código aqui, manipule a variável sem alterar o nome dela.
...
function conditionCase() {
  let maior20 = historicoDeResultado[(historicoDeResultado.length)-1]
  if ( maior20 >= 20) {
